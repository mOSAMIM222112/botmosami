...
global.botnumber = "212622181951";

global.owner = [
  ["212620986991", "@м.ṡ.м/مِٰـصِٰـۛৣــــمِ🇸🇰༒", true],
  ["212620986991"],
  ["212620986991"],
  ["212620986991"],
  ["212620986991"],
...
global.suittag = ["212620986991"];
global.prems = ["212620986991"];

global.packname = "B🄾🅃 M🄾🅂🄰🄼🄸🄼";
global.author = "B🄾🅃 M🄾🅂🄰🄼🄸🄼";
global.wm = "B🄾🅃 M🄾🅂🄰🄼🄸🄼";
global.titulowm = "B🄾🅃 M🄾🅂🄰🄼🄸🄼";
global.titulowm2 = "B🄾🅃 M🄾🅂🄰🄼🄸🄼";
global.igfg = "B🄾🅃 M🄾🅂🄰🄼🄸🄼";
global.wait =
  "*شكرا على استعمال بوت B🄾🅃 M🄾🅂🄰🄼🄸🄼 . ⁽🇸🇰₎⇣℡ . المرجو انتظار قليلا.......*";
...
global.fgif = {
  ...
  message: {
    videoMessage: {
      ...
      gifPlayback: "true",
      caption: bottime,
      imgThumbnail: fs.readFileSync("./Menu3.png"),
    },
  },
};
