...
const handler = async (m, { conn, command, usedPrefix }) => {
  ...
  switch (command) {
    case "pack":
      ...
      conn.sendMessage(
        m.chat,
        { image: { url: url }, caption: `_🥵 Pack 🥵_` },
        { quoted: m },
      );
      break;
    case "pack2":
      ...
      conn.sendMessage(
        m.chat,
        { image: { url: url2 }, caption: `_🥵 Pack 🥵_` },
        { quoted: m },
      );
      break;
    case "pack3":
      ...
      conn.sendMessage(
        m.chat,
        { image: { url: url3 }, caption: `_🥵 Pack 3 🥵_` },
        { quoted: m },
      );
      break;
    case "videoxxx":
    case "vídeoxxx":
      const url4 =
        await videosxxxc[Math.floor(Math.random() * videosxxxc.length)];
      await conn.sendMessage(
        m.chat,
        { video: { url: url4 }, caption: `*ᴅɪsғʀᴜᴛᴀ ᴅᴇʟ ᴠɪᴅᴇᴏ 🥵*` },
        { quoted: m },
      );
      break;
    case "videoxxxlesbi":
    ...
    case "pornolesv":
      const url5 =
        await videosxxxc2[Math.floor(Math.random() * videosxxxc2.length)];
      await conn.sendMessage(
        m.chat,
        { video: { url: url5 }, caption: `*ᴅɪsғʀᴜᴛᴀ ᴅᴇʟ ᴠɪᴅᴇᴏ 🥵*` },
        { quoted: m },
      );
      break;
  }
