...
*[ 🏃🏃 ] جاري تحميل الملف...*`.trim();
    m.reply(captionES);
    await conn.sendFile(m.chat, resEX.url, resEX.filename, "", m, null, {
      mimetype: resEX.ext,
      asDocument: true,
    });
  } catch {
...
**[ 🏃🏃 ] جاري تحميل الملف...*`.trim();
      ...
      await m.reply(
        "اعتذر لكن فشلنا في تنزيل ملفك ربما يكون الملف كبيرا او انه محذوف من المنصة ",
      );
    }
  }
};
